...
public class Trabajo implements Comparable<Trabajo>{
    ...
    public Trabajo(String titulo, List area, int duracion, LocalDate comienzo, LocalDate aprobacion, List alumTrabajo, List rolTrabajo) {
        this.titulo = titulo;
        this.duracion = duracion;
        this.comienzo = comienzo;
        this.alumTrabajo = alumTrabajo;
    ...
    public String nuevoSeminario(LocalDate fechaExposicion, NotaAprobacion nota, String observaciones){
        ...
        try{
            ...
            if(fechaExposicion.isBefore(presentacion)){
                return "La fecha no es valida, no se agregó el seminario a la lista.";
            }
            
        }
        catch(NullPointerException e){
            return "No se pudo agregar el seminario. 1";
        }
//           
            ...
            this.seminarios.add(new Seminario(fechaExposicion, nota, observaciones));
